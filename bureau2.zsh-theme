...
_USERNAME="$_USERNAME%{$reset_color%}@%{$fg_bold[yellow]%}%{%m$reset_color%}"
...
get_space () {
	...
	local SPACES=$(( COLUMNS - LENGTH - ${ZLE_RPROMPT_INDENT:-1} - 4 ))
...
_1RIGHT="%{$fg_bold[red]%}[-%{$reset_color%}%*%{$fg_bold[red]%}-]%{$reset_color%}"
